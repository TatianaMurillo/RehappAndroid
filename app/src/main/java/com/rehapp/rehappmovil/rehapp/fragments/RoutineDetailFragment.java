...
public class RoutineDetailFragment extends Fragment {
    ...
    private List<Object> getDataFromView(){
        ExerciseRoutinesViewModel exerciseRoutine= new ExerciseRoutinesViewModel();
        ...
        if(validateDataFromView()) {
            ...
            exerciseRoutine.setDuration(duration);
            exerciseRoutine.setExercise_routine_id(routineId);
            exerciseRoutine.setSpeed(speed);
            exerciseRoutine.setFrequency(frequent);
            exerciseRoutine.setIntensity(intensity);
            exerciseRoutine.setPreconditions(preconditions);
            exerciseRoutine.setObservations(observation);
        }else{
            return Arrays.asList(exerciseRoutine,false);
        }
        return Arrays.asList(exerciseRoutine,true);
