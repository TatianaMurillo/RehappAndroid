...
public class ExerciseRoutineApiAdapter {

    private static ExerciseRoutineApiService API_SERVICE;

    public static ExerciseRoutineApiService getApiService() {
        ...
        if (API_SERVICE == null) {
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            API_SERVICE = retrofit.create(ExerciseRoutineApiService.class);
        }
