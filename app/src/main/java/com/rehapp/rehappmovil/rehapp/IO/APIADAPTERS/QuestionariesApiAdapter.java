...
public class QuestionariesApiAdapter {


    private static QuestionariesApiService API_SERVICE;

    public static QuestionariesApiService getApiService() {
        ...
        if (API_SERVICE == null) {
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            API_SERVICE = retrofit.create(QuestionariesApiService.class);
        }
