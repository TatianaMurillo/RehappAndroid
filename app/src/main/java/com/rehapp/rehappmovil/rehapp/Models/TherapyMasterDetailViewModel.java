...
public class TherapyMasterDetailViewModel extends TherapyViewModel {
    ...
    public TherapyMasterDetailViewModel(int institution_id, int patient_id, int therapist_id, boolean therapy_achieved_the_goal, String therapy_additional_information, int therapy_id, int therapy_sequence, double therapy_total_duration, String therapy_description, String therapy_observation, String therapy_date, String therapy_time, InstitutionViewModel institucion, PatientViewModel patient, TherapistViewModel therapistViewModel, String action, TherapistViewModel therapist, PatientViewModel patient1, InstitutionViewModel institution, List<List<PhysiologicalParameterTherapyViewModel>> physiologicalParameterViewModel) {
