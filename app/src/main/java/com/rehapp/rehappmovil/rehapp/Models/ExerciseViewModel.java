...
public class ExerciseViewModel {
    ...
    private String exercise_routine_id;
    private String exercise_routine_url;
    private String exercise_routine_name;
    private String exercise_routine_description;


    public ExerciseViewModel(String exercise_routine_id, String exercise_routine_url, String exercise_routine_name, String exercise_routine_description) {
    ...
    public void setExercise_routine_id(String exercise_routine_id) {
        this.exercise_routine_id = exercise_routine_id;
    }
