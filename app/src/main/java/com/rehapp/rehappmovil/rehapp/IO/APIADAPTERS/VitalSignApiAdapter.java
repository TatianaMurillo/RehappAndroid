...
public class VitalSignApiAdapter {


    private static VitalSignApiService API_SERVICE;

    public static VitalSignApiService getApiService() {
        ...
        if (API_SERVICE == null) {
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            API_SERVICE = retrofit.create(VitalSignApiService.class);
        }
