...
public class DiseaseApiAdapter {

    private static DiseaseApiService API_SERVICE;

    public static DiseaseApiService getApiService() {
        ...
        if (API_SERVICE == null) {
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            API_SERVICE = retrofit.create(DiseaseApiService.class);
        }
